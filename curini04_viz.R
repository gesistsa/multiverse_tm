...
condit_effect <- read.csv(here::here("results", "aggregated", "curini", "condit_1.csv"))

condit_effect |> ggplot(aes(x = LR, y = pred_multi100, group = i)) + geom_line(alpha = 0.05) + xlab("LR") + ylab(expression(theta)) + theme_minimal() 
