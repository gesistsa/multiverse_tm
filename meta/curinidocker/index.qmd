...
The original code is not reproducible because of the following factors: (1) how the documents are tokenized, (2) stochastic instability, and (3) change in software; even the data and code is largely the same.
