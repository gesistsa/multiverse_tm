---
title: Reproducibility of Curini and Vignoli (2021)
...
The original estimate is not reproducible because of the following factors: 

1. how the documents are tokenized
2. stochastic instability
3. changes in software, even the data and code is largely the same
