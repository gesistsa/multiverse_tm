...
**Requires R 4.1.0 or newer** We tested our code on R 4.5.0 and R 4.5.1 on Ubuntu Linux.
...
rpkgs <- suppressMessages(sort(unique(renv::dependencies(quiet = TRUE)$Package)))
cat(paste0("```r\nPackages <- c(\n",
           paste(paste0("    \"", rpkgs, "\""),
...
[^1]: There are also additional dependencies for developers: `withr` and `rmarkdown`
